...
class PFLDInference(nn.Module):
    def __init__(self, alpha=1.0):
        ...
        self.block5_6 = InvertedResidual(self.base_channel*2, self.base_channel*2, 2, False, 4)
...
if __name__ == "__main__":
    ...
    model = PFLDInference(alpha=0.25)
    features  = model(x)
